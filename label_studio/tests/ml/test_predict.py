...
def test_get_single_prediction_on_task(business_client, ml_backend_for_test_predict) -> None:
...
@pytest.mark.django_db
def test_get_multiple_predictions_on_task(business_client, ml_backend_for_test_predict) -> None:
    project = make_project(
        config=dict(
            is_published=True,
            label_config="""
