...
class UserHotkeysAPITestCase(TestCase):
    ...
    def test_update_hotkeys_authenticated(self) -> None:
    ...
    def test_update_hotkeys_unauthenticated(self) -> None:
    ...
    def test_update_hotkeys_invalid_data(self) -> None:
    ...
    def test_update_hotkeys_partial(self) -> None:
    ...
    def test_empty_hotkeys(self) -> None:
    ...
    def test_get_hotkeys_authenticated(self) -> None:
    ...
    def test_get_hotkeys_unauthenticated(self) -> None:
    ...
    def test_get_hotkeys_empty_config(self) -> None:
